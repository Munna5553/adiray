...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="z-50  w-full h-[100px]  bg-[#E8EDF3]  fixed flex items-center justify-center shadow-  ">
            ...
            <motion.nav
                ...
                className={`z-50 fixed w-full h-[100px] px-4 border-b-2 flex flex-col justify-center items-center  `}>
